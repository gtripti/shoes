...
<br>
<form:form method="post" action="UpdateProductToDB" modelAttribute="Product" style="margin: auto; width: 80%; text-align: center;">

	<br>
	<form:input path="name" type="text" class="form-control" placeholder="Product Name" />	
	<br>
	<form:input path="price" type="text" class="form-control" placeholder="Product Price" />
	<br>
	<form:input path="qty" type="text" class="form-control" placeholder="Product Quantity" />
	<br>
